---
name: jeeves-correspondence
description: Run the Jeeves correspondence phase (v3.0 cloud, Gmail only). Sweeps Gmail (last 60 days), classifies messages by action type, weaves in five profane butler asides, and sends a 1,500-word correspondence briefing directly to lang.mc@gmail.com. Invoke independently of the daily intelligence pipeline.
