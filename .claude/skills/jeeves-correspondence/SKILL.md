...
description: Run the Jeeves correspondence phase (v3.0 cloud, Gmail only). Sweeps Gmail (last 60 days), classifies messages by action type, weaves in five profane butler asides, and delivers a 1,500-word correspondence briefing as a Gmail draft. Invoke independently of the daily intelligence pipeline.
